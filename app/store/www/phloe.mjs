 ...
 */
class StringAr {
 _r(S) { Object.values(this.$).forEach(_r, S.add(this.r)) } _f() { return this._.map(_f, this.$) }
 ...
 HTMLgetRequireList(L = new Set(), L1 = new Set()) { var l1 = L1.size; this._r(L1); if ((l1 -= L1.size) < 0) { var l = L.size;[...L1].slice(l1).forEach(SSaE, L); if ((l -= L.size) < 0) return [...L].slice(l) } return [] }
